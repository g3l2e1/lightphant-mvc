...
class AsindSqlFormatter
{
	...
	public static $quote_attributes = 'style="color: royalblue;"';
	...
	public static $number_attributes = 'style="color: #BE8CC8;"';
	public static $word_attributes = 'style="color: turquoise;"';
	public static $error_attributes = 'style="background-color: tomato;"';
	public static $comment_attributes = 'style="color: #aaa;"';
	public static $variable_attributes = 'style="color: orange;"';
	public static $pre_attributes = 'style="color: #BCD42A; background-color: white;"';
	...
	protected static function init()
	{
		...
		usort(self::$reserved, array('AsindSqlFormatter', 'sortLength'));
		
		// Set up regular expressions
		self::$regex_boundaries = '('.implode('|',array_map(array('AsindSqlFormatter', 'quote_regex'),self::$boundaries)).')';
		self::$regex_reserved = '('.implode('|',array_map(array('AsindSqlFormatter', 'quote_regex'),self::$reserved)).')';
		self::$regex_reserved_toplevel = str_replace(' ','\\s+','('.implode('|',array_map(array('AsindSqlFormatter', 'quote_regex'),self::$reserved_toplevel)).')');
		self::$regex_reserved_newline = str_replace(' ','\\s+','('.implode('|',array_map(array('AsindSqlFormatter', 'quote_regex'),self::$reserved_newline)).')');
		
		self::$regex_function = '('.implode('|',array_map(array('AsindSqlFormatter', 'quote_regex'),self::$functions)).')';
	 ...
	 */
	public static function format($string, $highlight=true, $theme=null)
	{
